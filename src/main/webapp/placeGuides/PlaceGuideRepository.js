    ...
    updatePlaceGuides(bounds, zoom) {
        ...
        if (PlaceGuideRepository.MIN_ZOOM <= zoom) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                thisRepository._placeGuides[placeGuide.id] = placeGuide;
                ...
                thisRepository._placeGuides[placeGuide2.id] = placeGuide2;
                Location.constructLocationBasedOnPlaceId("ChIJe-ff-71RqEcRqvy8lRR4PHo").then(location3 => {
                    ...
                    thisRepository._placeGuides[placeGuide3.id] = placeGuide3;
                }).then(response => {
                    Location.constructLocationBasedOnPlaceId("ChIJM3bYao8OSUcRpHGkCCTD9yM").then(location4 => {
                        ...
                        thisRepository._placeGuides[placeGuide4.id] = placeGuide4;
