 ...
 *
 * It is checked (the check is done by the servlet)
 * if the user logs in for the first time to the website.
 * If yes, their data(id and email) will be atutomatically saved in the database.
 *
 * After having their data saved if needed, the user will see a form for editing
 * portfolio data.
